...
(function($) {
    ...
    $('.addtocart_btn a').on('click', function () {
        $.notify({
            icon: 'fa fa-check',
            title: ' انجام شد!',
            message: 'مورد با موفقیت به سبد خرید شما اضافه شد'
        },{
            element: 'body',
            position: null,
            type: "انجام شد!",
            ...
            '<button type="button" aria-hidden="true" class="close" style="left:0" data-notify="dismiss">×</button>' +
    ...
    $('.product-box button .ti-heart, .product-box a .ti-heart').on('click', function () {
        $.notify({
            icon: 'fa fa-check',
            title: 'انجام شد!',
            message: 'مورد با موفقیت به لیست علاقه مندی ها اضافه شد'
...
(function() {
    $('<div class="sidebar-btn dark-light-btn">' +
        ...
        '<div class="theme-layout-version">تیره' +
        '</div>' +
        '</div>' +
        '</div>').appendTo($('body'));
})();
...
body_event.on("click", ".theme-layout-version" , function(){
    ...
    if($('.theme-layout-version').hasClass('dark')){
        ...
        $('#theme-dark').remove();
        $('.theme-layout-version').text('تیره');
    }
