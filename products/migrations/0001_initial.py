    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_at', models.DateTimeField(auto_now_add=True)),
                ('update_at', models.DateTimeField(auto_now=True)),
                ('product_name', models.CharField(max_length=100, verbose_name='نام غذا')),
                ('slug', models.SlugField(allow_unicode=True, max_length=100, unique=True, verbose_name='slug')),
                ('product_number', models.PositiveSmallIntegerField(default=0, verbose_name='تعداد غذاهای موجود')),
                ('is_active', models.BooleanField(default=True, verbose_name='فعال')),
                ...
                ('type_category', models.CharField(blank=True, choices=[('featured', 'پیشنهاد شگفت\u200cانگیز'), ('popular', 'محبوب ترین'), ('discounted', 'تخفیفات ویژه'), ('electronics', 'الکترونیک'), ('clothing', 'لباس'), ('shoes', 'کفش')], max_length=50, null=True)),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='category_product', to='products.category')),
                ('image', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='product_images', to='images.images')),
            ],
            options={
                'verbose_name': 'غذا',
